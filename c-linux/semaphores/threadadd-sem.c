 ...
 * 
    ...
    gcc -o threadadd-sem threadadd-sem.c -lpthread -lrt
* 
* */
...
int main()
{
	...
	printf("Create a new producer \n");
	pthread_create(&idA, NULL, Producer, (void*)index);
	pthread_create(&idB, NULL, Producer, (void*)index);
	pthread_create(&idC, NULL, Producer, (void*)index);
